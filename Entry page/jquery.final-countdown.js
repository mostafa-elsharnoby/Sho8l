...
(function ($) {
    ...
    function dispatchTimer() {
        timer = {
            ...
            days: Math.floor((settings.end - settings.now) / (1000 * 60 * 60 * 24)),
            hours: 24 - Math.floor(((settings.end - settings.now) % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60)),
            minutes: 60 - Math.floor(((settings.end - settings.now) % (1000 * 60 * 60)) / (1000 * 60)),
